  ...
  <body>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <h6 class="card-subtitle mb-2 text-muted" style="font-family: 'Secular One', sans-serif; text-align: center">user page</h6>
            <form action="/loginuser/compare" method="POST">
                @csrf
                <span>Email </span>
                <div>
